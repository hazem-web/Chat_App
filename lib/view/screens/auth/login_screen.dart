...
import 'package:firebaseapp/view/screens/auth/register_screen.dart';
      ...
      body: Padding(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ImageIcon(AssetImage('assets/speech-bubble.png'),size: 60,color: Colors.teal,),
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Provider.of<AuthProvider>(context,listen: false).login(email: _email.text, password: _password.text);
                    }
                  },
